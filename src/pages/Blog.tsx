...
const Blog = () => {
  ...
  const popularPosts = [
    { title: "Getting Started with WooCommerce", date: "Dec 10, 2025" },
    { title: "DNS Explained: A Beginner's Guide", date: "Dec 8, 2025" },
    { title: "Top 5 CDN Providers Compared", date: "Dec 5, 2025" },
    { title: "Email Hosting Best Practices", date: "Dec 3, 2025" },
  ];
